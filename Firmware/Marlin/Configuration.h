...
#define STRING_CONFIG_H_AUTHOR "(Scott Pidzarko)" // Who made the changes.
...
// Disable max endstops for compatibility with endstop checking routinez
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {200.0,200.0,200.0*8/3,760*1.1}  // default steps per unit for Ultimaker --> {x,y,z,e}
